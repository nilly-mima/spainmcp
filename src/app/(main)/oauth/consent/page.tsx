    ...
    <div className="min-h-[80vh] flex flex-col items-center justify-center py-12 px-4">
      ...
      >
        ...
        <div className="flex flex-col items-center gap-3 text-center">
          <div className="w-14 h-14 rounded-2xl bg-blue-50 dark:bg-orange-900/20 flex items-center justify-center text-2xl">
            🔐
          </div>
          <h1 className="text-lg font-bold text-[var(--foreground)] leading-snug">
            <span className="text-blue-600">{details?.client.name ?? 'Una aplicación'}</span>
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            disabled={deciding}
            className="flex-1 py-2.5 rounded-xl text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 disabled:opacity-60 transition-colors"
          >
            {deciding ? '...' : 'Aprobar'}
          </button>
        </div>
