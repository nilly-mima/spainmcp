...
function ThemeToggle() {
  ...
  const btn = (mode: Theme, label: string, Icon: React.FC) =>
    <button
      key={mode}
      ...
      className={`p-1.5 rounded-md transition-colors cursor-pointer ${
        theme === mode
          ? 'bg-white dark:bg-stone-700 text-gray-800 dark:text-gray-100 shadow-sm'
          : 'text-gray-400 dark:text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 hover:bg-stone-200/70 dark:hover:bg-stone-700/50'
      }`}
    >
      <Icon />
    </button>
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10">
          ...
          <div className="col-span-2 md:col-span-1 flex flex-col gap-3">
            <Link href="/" className="flex items-center gap-2 font-bold text-gray-900 dark:text-gray-100 hover:text-blue-600 dark:hover:text-blue-400 transition-colors w-fit">
          ...
          {/* Recursos */}
          <div>
            <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-4">Recursos</h3>
            <ul className="flex flex-col gap-2.5">
              {LINKS.recursos.map(({ label, href }) => (
                <li key={href}>
                  <Link href={href} className="text-sm text-gray-400 dark:text-gray-500 hover:text-gray-800 dark:hover:text-gray-200 transition-colors">
                    {label}
                  </Link>
                </li>
              ))}
          ...
          {/* Empresa */}
          <div>
            <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-4">Empresa</h3>
            <ul className="flex flex-col gap-2.5">
          ...
          {/* Conectar */}
          <div>
            <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-4">Conectar</h3>
            <div className="flex items-center gap-3">
              <a href="https://github.com/nilly-mima/spainmcp" target="_blank" rel="noopener noreferrer"
                className="text-gray-400 dark:text-gray-500 hover:text-gray-800 dark:hover:text-gray-200 transition-colors" title="GitHub">
              ...
              <a href="https://discord.gg/spainmcp" target="_blank" rel="noopener noreferrer"
                className="text-gray-400 dark:text-gray-500 hover:text-gray-800 dark:hover:text-gray-200 transition-colors" title="Discord">
