  ...
  return (
    <header className="sticky top-0 z-10 bg-[var(--background)] border-b border-[var(--border)]">
      <div className="max-w-6xl mx-auto px-6 h-14 flex items-center gap-4">
        ...
        {/* Logo */}
        <Link href="/" className="flex items-center gap-2 font-bold text-base text-stone-900 dark:text-stone-100 hover:text-orange-600 dark:hover:text-orange-500 transition-colors shrink-0">
        ...
        {/* Nav */}
        <nav className="flex items-center gap-0.5 text-sm text-stone-500 dark:text-stone-400 shrink-0">
